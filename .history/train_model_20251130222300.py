...
print("A: starting train_model.py")

import numpy as np
print("B: imported numpy")

import torch
print("C: imported torch")

# any other big libs you import:
# import faiss, xformers, mujoco, etc.
# print("D: imported faiss")
# print("E: imported xformers")

print("F: before anything else")

print("G: before importing your modules")
import train_utils
print("H: imported train_utils")

print("I: before importing model")
from model import MyModel
print("J: imported MyModel")

print("K: before loading config")
config = load_config("config.yaml")
print("L: loaded config")

print("M: before building model")
